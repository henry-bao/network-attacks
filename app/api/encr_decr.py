...
# def test_encr_decr():
#     ec = Encryption()
#     ctx = ec.encrypt(b"hello world!!!!")

#     if ec.decrypt(ctx) == b"hello world!!!!":
#         print('pass')
#     else:
#         print("fail")
...
class Encryption(object):
    ...
    def decrypt(self, ctx):
        ...
        tag = ctx[self._block_size_bytes:self._block_size_bytes+16]  # GCM tag is typically 16 bytes
        ciphertext = ctx[self._block_size_bytes+16:]
